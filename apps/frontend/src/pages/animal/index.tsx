...
import { Especie, animalSchema, useCreateAnimal } from "@/api/animais/create";
...
export default function AnimaisPage() {
  ...
  const form = useForm<z.infer<typeof animalSchema>>({ resolver: zodResolver(animalSchema) });
  const { mutateAsync: criarSintoma } = useCreateAnimal();
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 w-full">
          <div className="grid grid-rows-1 grid-flow-col gap-4">
            <Avatar className="w-36 h-36 rounded-sm">
              ...
              <AvatarFallback className="bg-white">Animal</AvatarFallback>
            </Avatar>
          ...
          {/* Esse campo nao aparece para o usuario, serve apenas para mandar ligacao da imagem para o backend */}
